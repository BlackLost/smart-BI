...
describe('Login Page', () => {
  ...
  it('should show login form', async () => {
    ...
    await rootContainer.findAllByText('Smart BIs');
    ...
    expect(rootContainer.baseElement?.querySelector('.ant-pro-form-login-desc')?.textContent).toBe(
      'Smart BIs is the most influential web design specification in Xihu district',
    );
  ...
  it('should login success', async () => {
    ...
    await rootContainer.findAllByText('Smart BI');
